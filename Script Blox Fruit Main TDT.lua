...
if game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("Main (minimal)") then
    repeat
        ...
        l_Remotes_0.CommF_:InvokeServer("SetTeam", getgenv().Setting.Team)
        task.wait(3)
...
TextLabel.Text = "Matsune Hub Auto Bounty"
...
function sendKillWebhook(targetName, bountyEarned, currentBounty)
    ...
    local data = {
        ["embeds"] = {{
            ...
            ["description"] = "**Matsune Hub Auto Bounty!**",
            ["color"] = 0x67eb34,
            ["fields"] = {
                {
                    ["name"] = "🔫 Target",
    ...
    if getgenv().Setting.Webhook.Enabled and getgenv().Setting.Webhook.Url ~= "" then
        ...
        local data = {
            ["embeds"] = {{
                ...
                ["footer"] = {
                    ["text"] = "Matsune Hub • " .. os.date("%H:%M %d/%m/%Y")
                }
            }}
        }        
        pcall(function()
...
print("✅ Kill webhook has been activated!")
print("=== AUTO BOUNTY ĐÃ KHỞI ĐỘNG ===")
print("✅ Đã xóa toàn bộ click")
print("✅ Đã xóa tính năng Spectate Player")
print("✅ Team: " .. getgenv().Setting.Team)
print("✅ Có thể nhìn thấy người chơi và đảo")
print("✅ Visual bình thường")
print("✅ Sẵn sàng farm bounty!")
